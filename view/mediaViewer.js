...
render(){
  ...
  console.log(state.currentPic.getJson().owner)
  console.log(state.user.getJson()._id)
  return (
      ...
      horizontal={true}
        ...
        <View style={{marginRight:25,  marginTop:15, display:"flex", flexDirection:"row", alignSelf:"center"}}>
               ...
               <TouchableOpacity onPress={()=>{
                 ...
                 dispatch({currentFollowing:user, myswitch:"following", currentPic:undefined, popupSwitch:""})
               }}>
        ...
        <Text style={{cfontFamily: "Regular",olor:"white", alignSelf:'center', padding:40, paddingTop:20}}>{state.currentPic.getJson().description}</Text>
